...
import hcil.kaist.watchconnector_holdDemo.MainActivity.SerialListener;

public class SerialConnector {
    public static final String tag = "SerialConnector";

    private Context mContext;
    private MainActivity.SerialListener mListener;
...
//			Log.d(TAG, "Read " + numBytesRead + " bytes.");
    ...
    private void startThread() {
        ...
        mListener.onReceive(Constants.MSG_DEVICD_INFO, 0, 0, "Start serial monitoring thread \n", null);
        if(mSerialThread == null) {
            mListener.onReceive(Constants.MSG_DEVICD_INFO, 0, 0, "mSerialThread == null \n", null);
            ...
            while(!Thread.interrupted())
            {
                if(mPort != null) {
                    ...
                    try {
                        ...
                        int numBytesRead = mPort.read(buffer, 2);
                        if(numBytesRead > 0) {
